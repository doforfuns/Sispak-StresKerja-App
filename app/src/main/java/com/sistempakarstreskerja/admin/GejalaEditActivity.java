...
public class GejalaEditActivity extends AppCompatActivity {
    ...
    private static final String url = "https://streskerja.000webhostapp.com/get_gejala.php";
    private static final String url_update = "https://streskerja.000webhostapp.com/update_gejala.php";
    private static final String url_delete = "https://streskerja.000webhostapp.com/delete_gejala.php";
